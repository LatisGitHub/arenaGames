    ...
    <div class="mx-4 my-5">
        ...
        <table class='table table-striped' style='font-size: 15px;align-items: center;' id='dataTable' width='100%'
            ...
            @foreach ($juegos as $juego)
                <tr>
                    <td>
                        <p style="font-weight: bold">{{ strtoupper($juego->nombre) }}</p>
                    </td>
                    <td>
                    ...
                    <td class="text-center"> <a href="/juegos/{{ $juego->id }}" class="text-primary"><svg
                    ...
                    <td class="text-center"> <a class="text-danger" href="/juegos/{{ $juego->id }}/borrar"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
