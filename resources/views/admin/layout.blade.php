...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="/inicio">ArenaGames</a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse justify-content-center " id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a class="nav-link text-light" href="/inicio">HOME</a>
          <a class="nav-link text-light" aria-current="page" href="/juegos">JUEGOS</a>
          <a class="nav-link text-light" href="/equipos">EQUIPOS</a>
          <a class="nav-link text-light" href="/torneos">TORNEOS</a>
          @auth 
          <li><a class="nav-link scrollto text-light" href="/profile">PERFIL</a></li>
          @else
              <li><a class="nav-link scrollto text-light" href="{{ route('login') }}">LOGIN</a></li>
              @if (Route::has('register'))
                <li><a class="nav-link scrollto text-light" href="{{ route('register') }}">REGISTRARSE</a></li>
              @endif
          @endauth
        </div>
      </div>
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        ...
                        <p>
                            ArenaGames es una página en donde podrás planear con tus amigos distintos torneos, unirte y conocer nuevos grupos y 
