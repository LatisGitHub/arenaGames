        ...
        <table class='table table-striped' style='font-size: 15px;align-items: center;' id='dataTable' width='100%'
            ...
            @foreach ($torneos as $torneo)
                <tr>
                    ...
                    <td class="text-center"><a href="/torneos/{{ $torneo->id }}" class='text-primary'><svg
                    ...
                    <td class="text-center"> <a href="/torneos/{{ $torneo->id }}/borrar" class="text-danger"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
