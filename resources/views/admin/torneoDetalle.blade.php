        ...
        <div class="card text-center mt-4">
            ...
            <div class="card-body">
                @foreach ($juegos as $juego)
                    ...
                    @endif
                @endforeach
                <p class="card-text">FECHA DE INICIO: {{ $torneo->fecha }}</p>
                <p class="card-text">NIVEL: {{ strtoupper($torneo->nivel) }}</p>
                <p class="card-text"> <b>MODALIDAD DEL JUEGO: {{ $torneo->modalidad }} VS {{ $torneo->modalidad }}</b></p>
        ...
        <div class='row mb-5 mt-3 '>
            @foreach ($equipos as $equipo)
                <div class="card m-3" style="width: 18rem;">
                    ...
                    <a class="btn btn-danger" href="/torneos/{{ $torneo->id }}/equipos/{{ $equipo->id }}/borrar"><svg
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><b>MODALIDAD: {{ $equipo->modalidad . ' VS ' . $equipo->modalidad }}</b></p>
                        <p class="card-text"><b>ESTADO: {{ strtoupper($equipo->estado) }}</b></p>
                    </div>
                </div>
            @endforeach
        </div>
